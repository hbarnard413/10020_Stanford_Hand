 ...
 */
void profile_velocity_test(chanend c_velocity_ctrl, chanend c_hall) {
    int acceleration = 50; // 4000rpm/s
    int deceleration = 50; // 4000rpm/s
    int velocity_read = 0;
    ...
    set_profile_velocity(10, acceleration, deceleration,
    ...
    /*while (1)
    {
        velocity_read = get_hall_velocity(c_hall);
        printstr("Velocity ");
        printint(velocity_read);
    }*/
}

/* Test Profile Torque Function */
void profile_torque_test(chanend c_torque_ctrl, chanend c_hall)
{
    ...
    /*while (1)
    {
        torque_read = get_torque(c_torque_ctrl);
        velocity_read = get_hall_velocity(c_hall);
        printstr("Velocity ");
        printint(velocity_read);
        printstr("Torque ");
        printint(torque_read);
    }*/
    /*
    target_torque = 0;
    set_profile_torque( target_torque, torque_slope, cst_params, c_torque_ctrl);
...
int main(void) {
    ...
    chan c_qei_p1_0, c_qei_p2_0, c_qei_p3_0; // node 2 qei channels
    ...
    chan c_torque_ctrl_0; // node 0 torque control channel
    chan c_watchdog_0; // node 2 WDT channel
    chan c_adc_0;//node 0 adc channel
            ...
            par {
                {
                    ...
                    //profile_torque_test(c_torque_ctrl_0, c_hall_p4_0);
                }
/*                 Velocity Control Loop
                ...
                /* Torque Control Loop */
                {
                    ctrl_par torque_ctrl_params_0;
                    filter_par sensor_filter_params_0;
                    hall_par hall_params_0;
                    qei_par qei_params_0;

                    init_torque_control_param(torque_ctrl_params_0);
                    ...
                    torque_control( torque_ctrl_params_0, hall_params_0, qei_params_0, SENSOR_USED,
                            c_adc_0, c_commutation_p1_0,  c_hall_p3_0,  c_qei_p3_0, c_torque_ctrl_0);
                }
            }
        }
            ...
            par {
                {
                   ...
                   // profile_velocity_test(c_velocity_ctrl_1, c_hall_p4_1);
                    //profile_torque_test(c_torque_ctrl_1, c_hall_p4_1);
                }
/*                 Velocity Control Loop
                {
            ...
            par {
                {
                    ...
                    //profile_torque_test(c_torque_ctrl_2, c_hall_p4_2);
                }
/*                 Velocity Control Loop
                {
